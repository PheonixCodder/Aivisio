...
const RecentImages = ( { images }: GalleryProps) => {
    if (images.length === 0) {
        return (
            <Card className='col-span-3'>
                ...
                <CardContent className='flex items-center justify-center'>
                    <p className='text-muted-foreground mt-16'>No Images Generated</p>
                </CardContent>
            </Card>
        )
    }
  return (
    ...
    <div className='flex justify-end'>
        ...
        <Button variant={"ghost"} size={"sm"}>View Gallery<ArrowRight className='ml-2 w-4 h-4' /></Button>
        </Link>
    </div>
                </CardContent>
            </Card>
